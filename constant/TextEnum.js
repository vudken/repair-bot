...
const BTN = Object.freeze({
	...
	COMPLETE: 'Завершить',
	ADD_COMMENT: `${emoji.get('arrow_up')} Добавить комментарий `,
...
const INFO = Object.freeze({
	...
	PHOTO_WARNING: `${emoji.get('⚠️')} Отправляйте фото только, когда выберете адрес, пройдёте все шаги завершения работы и увидите сообщение с текстом <b>"Прикрепите фото, нажав на скрепку"</b>!`,
	CAUSE_WARNING: `${emoji.get('⚠️')} Пожалуйста, выберите, что вы отремантировали перед тем как продолжить!`,
	COMMENT_ADDED: `Ваш комментарий добавлен к работе ${emoji.get('👌')}`
});
...
const OTHER = Object.freeze({
	...
	ERROR: `${emoji.get('❗')}Произошла ошибка, попробуйте заново или свяжитесь с администрацией`,
	ADD_COMMENT: `${emoji.get('💬')}Оставьте свой комментарий:`,
});
